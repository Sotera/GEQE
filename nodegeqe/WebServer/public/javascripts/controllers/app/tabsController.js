angular.module('NodeWebBase')
    .controller('tabsController', function ($scope, $rootScope) {
        ...
        //$scope.dropZone = $("#drop_zone").get(0);
        //$scope.dropZone.addEventListener('dragover', $scope.handleDragOver, false);
        //dropZone.addEventListener('drop', $scope.handleDrop, false);
        //$(dropZone).click($scope.onDropZoneClicked);
